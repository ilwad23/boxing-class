    ...
    <main className="mainContent">
      <div className="about">
        ...
        <p className="about__para">
          urna, at ullamcorper at ipsum, vitae placerat. Ullamcorper proin Lorem
          ipsum dolor sit amet, consectetur adipiscing elit. Sed arcu venenatis
          vitae, scelerisque. Suspendisse at vulputate feugiat pretium enim
          tincidunt.
        </p>
      </div>
      <div>
        ...
        <Info
          ...
          title="Our prices"
          points={["Lorem ipsum dolor sit amet", "Lorem ipsum dolor sit amet"]}
        />
      </div>
      <a
        href="https://www.instagram.com/stfeyes/"
        className="mainContent__btn btns"
      >
